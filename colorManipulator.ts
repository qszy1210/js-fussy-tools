 ...
 */
export function convertColorToString(color:any) : string{
 ...
 */
export function convertHexToRGB(color : any) : string {
  if (color.length === 4) {
    let extendedColor = '#';
 ...
 */
export function decomposeColor(color: any) : {type:string, values:string}{
  if (color.charAt(0) === '#') {
 ...
 */
export function emphasize(color: any, coefficient:number = 0.15): string {
 ...
 */
export function fade(color: any, value: number): string {
  color = decomposeColor(color);
